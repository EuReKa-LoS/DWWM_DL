...
<!--Head-->
<?php
$optionTitle="Modification de Label";
$path="../CSS/styles.css";
...
<body>
  ...
  <div class="sign2">
    <h1><span class="fast-flicker">Modifi</span>er u<span class="flicker">n La</span>bel</h1>
  </div>

  <form class="position-absolute top-50 start-50 translate-middle" action="modifLabel.php" method="post">
    code du label :
